...
export const DATA = {
  ...
  summary: `Curious. Always building, breaking, and learning.
  ...
  projects: [
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/seekernothing/nevochat",
    ...
    {
      title: "Medsee",
      href: "https://medsee.vercel.app/",
      dates: "April 2025",
      active: true,
      description:
        "Medsee is a modern medical landing page built to present healthcare services with a clean, professional UI. Features smooth animations, responsive design, and a component-driven layout built with shadcn/ui and Framer Motion.",
      technologies: [
        "Next.js",
        "TypeScript",
        "Tailwind CSS",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/seekernothing/medsee",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "/images/products/medsee.jpg",
      video: "",
    },
    // {
