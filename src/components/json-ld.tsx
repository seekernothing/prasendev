    ...
    },
    {
      ...
      potentialAction: {
        ...
        target: {
          "@type": "EntryPoint",
          urlTemplate:
            "https://seekernothing.com/search?q={search_term_string}",
        },
      ...
      hasPart: [
        {
          ...
          url: "https://seekernothing.com/projects",
        },
        {
          "@type": "WebPage",
          name: "Blog",
          description: "Technical articles and tutorials",
          url: "https://seekernothing.com/blog",
        },
        {
          "@type": "WebPage",
          name: "CLI",
          description: "Command line interface projects",
          url: "https://seekernothing.com/cli",
        },
      ],
    },
  ];
